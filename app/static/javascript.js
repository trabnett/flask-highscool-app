...
$(document).ready(function(){
    ...
    $('#school').height($(window).height() - $('.first').height()).css({'background-repeat': 'no-repeat', 'background-attachment': 'scroll', 'background-size': 'cover', 'max-height': '10px'}).attr("class","")
